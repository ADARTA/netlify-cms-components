 ...
 * To be called from our webpack devServer config.before
 * See: http://expressjs.com/en/guide/using-middleware.html
 * 
 * const fsExpressAPI = require('netlify-cms-backend-fs/dist/scripts/fs/fs-express-api');
 * // CRA v2 using the ./src/setupProxy.js
 * module.exports = fsExpressAPI;
 * 
 * // webpack v4.x devServer config
 * module.exports = {
 *   //.....
 *   devServer: {
 *     before: fsExpressAPI,
...
const fsPath = pkg.fileSystemPath || '';
